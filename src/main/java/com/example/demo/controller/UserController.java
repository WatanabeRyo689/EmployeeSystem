...
import com.example.demo.repository.UserSkillLevelRepository;
...
public class UserController {
	...
	private final UserSkillLevelRepository userSkillLevelRepository;
	 ...
	 @Autowired
	    public UserController(UserService userService,UserSkillLevelRepository userSkillLevelRepository) {
	        this.userService = userService;
	        this.userSkillLevelRepository = userSkillLevelRepository;
	}
	...
	public String write1(UserForm userForm,Model model) {
		...
		List<UserSkillLevel> test = userSkillLevelRepository.findByUserId("1");
